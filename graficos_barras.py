...
def grafico_barras_1():  # barras verticales
    peru = df.loc['Peru', anhos]
    peru.plot(kind='bar', figsize=(10, 6)) # esto es ta grafica de barras
...
def grafico_barras_2(): # Barras horizontales
  ...
  #  df_top = df.sort_values(by = '2018',  ascending=True, inplace=True)
    ...
    for index, value in enumerate(df_top):
        ...
        plt.annotate(value, xy=(value-1450, index-0.1), color='black')
#value 1450 es un valor para mostrar los valores de la etiqueta
